...
**capstone-online-website** This project is based on an online website for a conference called RR International Summit 2023. By the end of this month, this conference will take place in Dhaka, Bangladesh for people all over the world.
...
```sh
  cd my-folder
  git clone git@github.com:rabayarabu/capstone-online-website.git
```
...
Feel free to check the [https://github.com/rabayarabu/capstone-online-website/issues](../../issues/).
